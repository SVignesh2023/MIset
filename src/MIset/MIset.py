...
class MIset:
    ...
    def top_features(self):
        """Get a list of feature names deemed the most relevant by the feature selection algorithm.
        
        The feature names in the list are ranked in descending order (high to low) of their feature importance score.
    ...
    def feature_ranking(self):
        """Get a dictionary which provides the ranking of each feature deemed most relevant by the feature selection algorithm.
        
        The key of the dictionary is the rank while the value is its corresponding feature name.
        ...
        for key,value in self.selected_feature_score_dict.items():
            ranking_dict.update({counter:key})
            counter+=1
